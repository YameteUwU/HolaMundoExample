...
if (window.JotForm && JotForm.accessible) $('input_21').setAttribute('tabindex',0);
      JotForm.setCustomHint( 'input_21', 'Indique los requisitos del puesto' );
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,{"name":"publicar","qid":"2","text":"Publicar","type":"control_button"},null,{"description":"","name":"nombreDe","qid":"4","subLabel":"","text":"Nombre de Puesto","type":"control_textbox"},null,null,null,null,{"description":"","name":"fechaDe","qid":"9","text":"Fecha de Vencimiento","type":"control_birthdate"},null,null,null,null,null,null,null,null,null,{"name":"registroDe19","qid":"19","text":"Registro de ofertas de practica ","type":"control_head"},null,{"description":"","name":"requisitosDel","qid":"21","subLabel":"Escriba los requisitos del puesto, ej: Que tenga conocimientos en SQL.","text":"Requisitos del Puesto","type":"control_textarea"},{"description":"","name":"empresaO","qid":"22","subLabel":"","text":"Empresa o Entidad","type":"control_dropdown"},null,{"description":"","name":"descripcion","qid":"24","subLabel":"Descripcion del puesto","text":"Descripcion","type":"control_email"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,{"name":"publicar","qid":"2","text":"Publicar","type":"control_button"},null,{"description":"","name":"nombreDe","qid":"4","subLabel":"","text":"Nombre de Puesto","type":"control_textbox"},null,null,null,null,{"description":"","name":"fechaDe","qid":"9","text":"Fecha de Vencimiento","type":"control_birthdate"},null,null,null,null,null,null,null,null,null,{"name":"registroDe19","qid":"19","text":"Registro de ofertas de practica ","type":"control_head"},null,{"description":"","name":"requisitosDel","qid":"21","subLabel":"Escriba los requisitos del puesto, ej: Que tenga conocimientos en SQL.","text":"Requisitos del Puesto","type":"control_textarea"},{"description":"","name":"empresaO","qid":"22","subLabel":"","text":"Empresa o Entidad","type":"control_dropdown"},null,{"description":"","name":"descripcion","qid":"24","subLabel":"Descripcion del puesto","text":"Descripcion","type":"control_email"}]);}, 20); 
</script>
...
<style type="text/css" id="form-designer-style">
  ...
  .form-checkbox:hover+label:before, .form-checkbox:hover+span:before, .form-radio:hover+label:before, .form-radio:hover+span:before,
  .calendar.popup:before {
    border-color: rgba(226, 227, 228, 0.5);
  ...
  /*PREFERENCES STYLE*/
    ...
    .form-line-error .form-validation-error {
      ...
      .supernova {
        background-image: url("https://www.jotform.com/uploads/carol.guevara8814/form_files/bdlogin1.604bdfa80db368.78906084.png");
      }
      #stage {
        background-image: url("https://www.jotform.com/uploads/carol.guevara8814/form_files/bdlogin1.604bdfa80db368.78906084.png");
      }
...
<form class="jotform-form" action="https://submit.jotform.com/submit/210706387745865/" method="post" name="form_210706387745865" id="210706387745865" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="210706387745865" />
    ...
    <ul class="form-section page-section">
        ...
        <div class="form-header-group  header-large">
          <div class="header-text httal htvam">
            <h1 id="header_19" class="form-header" data-component="header">
              Registro de ofertas de práctica
            </h1>
            <div id="subHeader_19" class="form-subHeader">
              Llenar los campos con la información requerida para registar una oferta de práctica, luego se añadirán al catálogo de ofertas.
            </div>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input-wide jf-required" data-layout="half">
          <input type="text" id="input_4" name="q4_nombreDe" data-type="input-textbox" class="form-textbox validate[required]" style="width:310px" size="310" value="" placeholder=" " data-component="textbox" aria-labelledby="label_4" required="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_22">
        ...
        <div id="cid_22" class="form-input-wide jf-required" data-layout="half">
          <select class="form-dropdown validate[required]" id="input_22" name="q22_empresaO" style="width:310px" data-component="dropdown" required="" aria-labelledby="label_22">
      ...
      <li class="form-line" data-type="control_email" id="id_24">
        <label class="form-label form-label-top form-label-auto" id="label_24" for="input_24"> Descripción </label>
        <div id="cid_24" class="form-input-wide" data-layout="half">
          <span class="form-sub-label-container" style="vertical-align:top">
            <input type="email" id="input_24" name="q24_descripcion" class="form-textbox validate[Email]" style="width:310px" size="310" value="" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_24 sublabel_input_24" />
            <label class="form-sub-label" for="input_24" id="sublabel_input_24" style="min-height:13px" aria-hidden="false"> Descripción del puesto </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_birthdate" id="id_9">
        ...
        <div id="cid_9" class="form-input-wide jf-required" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q9_fechaDe[day]" id="input_9_day" class="form-dropdown validate[required]" data-component="birthdate-day" aria-labelledby="label_9 sublabel_9_day">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_9_day" id="sublabel_9_day" style="min-height:13px" aria-hidden="false"> Día </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q9_fechaDe[month]" id="input_9_month" class="form-dropdown validate[required]" data-component="birthdate-month" aria-labelledby="label_9 sublabel_9_month">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_9_month" id="sublabel_9_month" style="min-height:13px" aria-hidden="false"> Mes </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top">
              <select name="q9_fechaDe[year]" id="input_9_year" class="form-dropdown validate[required]" data-component="birthdate-year" aria-labelledby="label_9 sublabel_9_year">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_9_year" id="sublabel_9_year" style="min-height:13px" aria-hidden="false"> Año </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_21">
        <label class="form-label form-label-top" id="label_21" for="input_21"> Requisitos del Puesto </label>
        <div id="cid_21" class="form-input-wide" data-layout="full">
          <span class="form-sub-label-container" style="vertical-align:top">
            <textarea id="input_21" class="form-textarea" name="q21_requisitosDel" style="width:648px;height:163px" data-component="textarea" aria-labelledby="label_21 sublabel_input_21"></textarea>
            <label class="form-sub-label" for="input_21" id="sublabel_input_21" style="min-height:13px" aria-hidden="false"> Escriba los requisitos del puesto, ej: Que tenga conocimientos en SQL. </label>
          </span>
        </div>
      </li>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="210706387745865" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='210706387745865'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "210706387745865-210706387745865";
}
  </script>
</form>
